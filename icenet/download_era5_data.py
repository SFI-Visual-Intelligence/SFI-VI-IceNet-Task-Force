print("Entered download_era5_data.")
import sys
import os
...
print(f"Making sure {config.obs_data_folder} exists.")
if not os.path.isdir(config.obs_data_folder):
    os.makedirs(config.obs_data_folder)
    print(f"{config.obs_data_folder} did not exist so it was made.")
...
print(f"Starting to work on {sic_day_fpath} if it does not exist.")
